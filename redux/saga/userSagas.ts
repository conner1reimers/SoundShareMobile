...
function* checkForCookieAsync(action: any) {
  try {
...
function* fetchUserAsync(action: any) {
  try {
    console.log("GOING!")
...
// function* fetchUserServerAsync(action: any) {
//   try {
...
////////////////////////////////////////////////////////////////////////////////////
// GET LOGGED IN USER //
const fetchLoggedUser = async (uid: any) => {
...
////////////////////////////////////////////////////////////////////////////////////
// GET USER FOLLOWERS //
const fetchFollowers = async (followers: any) => {
  let result;
...
function* fetchFollowersAsync(action: any) {
  try {
...
////////////////////////////////////////////////////////////////////////////////////
// GET USER FOLLOWERS //
function* fetchFeedAsync(action: any) {
  try {
