...
function* BPMSearchAsync(action: any) {
  try {
...
const filterBrowse = async (action: any) => {
  let response;
...
const fetchBrowse = async (action: any) => {
...
function* fetchBrowseAsync({ type, payload }: any) {
...
////////////////////////////////////////////////////////////////////////////////////
// REFRESH  BROWSE //
const refreshBrowse = async ({offset, vals, order, query}: any) => {
  let insertVal;
...
function* refreshBrowseAsync(action: any) {
  try {
    yield call(loadAndCall,
      refreshBrowse,
